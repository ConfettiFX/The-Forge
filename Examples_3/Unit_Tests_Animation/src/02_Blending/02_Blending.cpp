...
const char* pszBases[] =
{
	"../../../src/02_Blending/",										// FSR_BinShaders
	"../../../src/02_Blending/",									// FSR_SrcShaders
	"",																		// FSR_BinShaders_Common
	"",																		// FSR_SrcShaders_Common
	"../../../UnitTestResources/",											// FSR_Textures
	"../../../UnitTestResources/",											// FSR_Meshes
	"../../../UnitTestResources/",											// FSR_Builtin_Fonts
	"../../../src/02_Blending/",										// FSR_GpuConfig
...
public:
	bool Init()
	{
		...
		//
		{
			...
			CollapsingBlendParamsWidgets.AddSubWidget(SliderFloatWidget("Blend Ratio", gUIData.mBlendParams.mBlendRatio, fValMin, fValMax, sliderStepSize));
			...
			CollapsingBlendParamsWidgets.AddSubWidget(SeparatorWidget());
			CollapsingBlendParamsWidgets.AddSubWidget(SliderFloatWidget("Clip Weight [Jog]", gUIData.mBlendParams.mJogClipWeight, fValMin, fValMax, sliderStepSize));
			...
			CollapsingBlendParamsWidgets.AddSubWidget(SeparatorWidget());
			CollapsingBlendParamsWidgets.AddSubWidget(SliderFloatWidget("Clip Weight [Run]", gUIData.mBlendParams.mRunClipWeight, fValMin, fValMax, sliderStepSize));
			...
			sliderStepSize = 0.01f;
			SliderFloatWidget SliderWalkAnimationTime("Animation Time", &gUIData.mWalkClip.mAnimationTime, fValMin, fValMax, sliderStepSize);
			...
			CollapsingJogClipWidgets.AddSubWidget(SeparatorWidget());
			CollapsingJogClipWidgets.AddSubWidget(SliderFloatWidget("Playback Speed", gUIData.mJogClip.mPlaybackSpeed, fValMin, fValMax, sliderStepSize));
			...
			CollapsingRunClipWidgets.AddSubWidget(SeparatorWidget());
			CollapsingRunClipWidgets.AddSubWidget(SliderFloatWidget("Playback Speed", gUIData.mRunClip.mPlaybackSpeed, fValMin, fValMax, sliderStepSize));
			CollapsingRunClipWidgets.AddSubWidget(SeparatorWidget());

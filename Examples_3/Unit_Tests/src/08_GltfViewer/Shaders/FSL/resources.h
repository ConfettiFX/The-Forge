...
RES(TexCube(float4), iemCubemap, UPDATE_FREQ_NONE, t15, binding = 15);
RES(TexCube(float4), pmremCubemap, UPDATE_FREQ_NONE, t16, binding = 16);
RES(Tex2D(float4), environmentBRDF, UPDATE_FREQ_NONE, t17, binding = 17);
RES(SamplerState, cubemapSampler, UPDATE_FREQ_NONE, t18, binding = 18);
#else

RES(Tex2D(float4), sceneTexture, UPDATE_FREQ_NONE, t6, binding = 6);
RES(Tex2D(float4), historyTexture, UPDATE_FREQ_NONE, t7, binding = 7);

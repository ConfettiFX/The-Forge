...
const char* pszRoots[] =
{
	...
	"../../../src/11_RendererRuntimeSwitch/GPUCfg/",	// FSR_GpuConfig
    "",										// FSR_OtherFiles
};
#endif
...
public:
	bool Init()
	{
		...
		{
			FileSystem::SetRootPath(FSR_SrcShaders, "../../../src/11_RendererRuntimeSwitch/PCVulkan/");
		}
		else if (settings.mApi == RENDERER_API_D3D12)
		{
			FileSystem::SetRootPath(FSR_SrcShaders, "../../../src/11_RendererRuntimeSwitch/PCDX12/");
		}

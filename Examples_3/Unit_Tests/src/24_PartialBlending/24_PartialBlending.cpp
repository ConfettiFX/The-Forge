...
class Blending: public IApp
{
	...
	bool Init()
	{
		...
		//
		{
			...
			uiSetWidgetOnEditedCallback(uiCreateCollapsingHeaderSubWidget(&CollapsingBlendParamsWidgets, "Upper Body Weight", &sliderFloat, WIDGET_TYPE_SLIDER_FLOAT), UpperBodyWeightCallback);
			...
			sliderFloat.mMax = fValMax;
			sliderFloat.mStep = sliderStepSize;
			uiSetWidgetOnEditedCallback(uiCreateCollapsingHeaderSubWidget(&CollapsingBlendParamsWidgets, "Joints Weight [Stand]", &sliderFloat, WIDGET_TYPE_SLIDER_FLOAT), StandClipJointsWeightCallback);
			...
			sliderFloat.mMax = fValMax;
			sliderFloat.mStep = sliderStepSize;
			uiSetWidgetOnEditedCallback(uiCreateCollapsingHeaderSubWidget(&CollapsingBlendParamsWidgets, "Joints Weight [Walk]", &sliderFloat, WIDGET_TYPE_SLIDER_FLOAT), WalkClipJointsWeightCallback);
			...
			uiCreateCollapsingHeaderSubWidget(&CollapsingUpperBodyRootWidgets, "", &separator, WIDGET_TYPE_SEPARATOR);
			...
			uiSetWidgetOnEditedCallback(uiCreateCollapsingHeaderSubWidget(&CollapsingUpperBodyRootWidgets, "Joint Index", &sliderUint, WIDGET_TYPE_SLIDER_UINT), UpperBodyJointIndexCallback);
			...
			sliderFloat.mMax = fValMax;
			sliderFloat.mStep = sliderStepSize;
			UIWidget* pAnimTime = uiCreateCollapsingHeaderSubWidget(&CollapsingStandClipWidgets, "Animation Time", &sliderFloat, WIDGET_TYPE_SLIDER_FLOAT);
			uiSetWidgetOnActiveCallback(pAnimTime, StandClipTimeChangeCallback);
			...
			luaRegisterWidget(uiCreateComponentWidget(pStandaloneControlsGUIWindow, "Upper Body Root", &CollapsingUpperBodyRootWidgets, WIDGET_TYPE_COLLAPSING_HEADER));
			luaRegisterWidget(uiCreateComponentWidget(pStandaloneControlsGUIWindow, "Stand Clip (Upper Body)", &CollapsingStandClipWidgets, WIDGET_TYPE_COLLAPSING_HEADER));
			luaRegisterWidget(uiCreateComponentWidget(pStandaloneControlsGUIWindow, "Walk Clip (Lower Body)", &CollapsingWalkClipWidgets, WIDGET_TYPE_COLLAPSING_HEADER));

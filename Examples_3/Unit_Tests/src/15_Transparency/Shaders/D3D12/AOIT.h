...
RasterizerOrderedTexture2D<uint> AOITClearMaskUAV  : UNIT_UAV_AOIT_MASK;
RWStructuredBuffer<AOITDepthData> AOITDepthDataUAV : UNIT_UAV_AOIT_DEPTH;
RWStructuredBuffer<AOITColorData> AOITColorDataUAV : UNIT_UAV_AOIT_COLOR;
#endif

#ifdef AOIT_ORDERED_ACCESS
Texture2D<uint> AOITClearMaskSRV                 : UNIT_SRV_AOIT_MASK;
StructuredBuffer<AOITDepthData> AOITDepthDataSRV : UNIT_SRV_AOIT_DEPTH;
StructuredBuffer<AOITColorData> AOITColorDataSRV : UNIT_SRV_AOIT_COLOR;
#endif
/************************************************************************/
// Helper functions
/************************************************************************/

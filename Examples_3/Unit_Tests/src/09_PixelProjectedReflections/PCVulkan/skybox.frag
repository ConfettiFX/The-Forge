...
void main()
{
	...
	outColor = vec4(pow(outColor.r, inverseArg), pow(outColor.g, inverseArg), pow(outColor.b, inverseArg), 0.0); // if alpha is zero, it won't contribute to render BRDF
	outNormal = vec4(0.0, 0.0, 0.0, 0.0);
	outRoughness = vec4(0.0, 1.0, 0.0, 0.0);
}
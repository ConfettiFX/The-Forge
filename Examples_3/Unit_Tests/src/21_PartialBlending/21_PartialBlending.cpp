...
const char* pszBases[FSR_Count] = {
	"../../../src/21_PartialBlending/",     // FSR_BinShaders
	"../../../src/21_PartialBlending/",     // FSR_SrcShaders
	"../../../UnitTestResources/",          // FSR_Textures
	"../../../UnitTestResources/",          // FSR_Meshes
	"../../../UnitTestResources/",          // FSR_Builtin_Fonts
	"../../../src/21_PartialBlending/",     // FSR_GpuConfig
...
class Blending: public IApp
{
	...
	void Draw()
	{
		...
		loadActions.mClearColorValues[0].a = 1.0;
	...
	const char* GetName() { return "21_PartialBlending"; }

...
class Blending: public IApp
{
	...
	bool Init()
	{
		...
		uiCreateComponent("Blended Animation", &guiDesc, &pStandaloneControlsGUIWindow);
		...
		//
		{
			...
			uiCreateCollapsingHeaderSubWidget(&CollapsingBlendParamsWidgets, "Blend Ratio", &sliderFloat, WIDGET_TYPE_SLIDER_FLOAT);

			uiCreateCollapsingHeaderSubWidget(&CollapsingBlendParamsWidgets, "", &separator, WIDGET_TYPE_SEPARATOR);

			CheckboxWidget checkbox;
			checkbox.pData = gUIData.mBlendParams.mAutoSetBlendParams;
			UIWidget* pAutoBlend = uiCreateCollapsingHeaderSubWidget(&CollapsingBlendParamsWidgets, "Auto Set Blend Params", &checkbox, WIDGET_TYPE_CHECKBOX);
			uiSetWidgetOnEditedCallback(pAutoBlend, AutoSetBlendParamsCallback);
			...
			sliderFloat.mMax = fValMax;
			sliderFloat.mStep = sliderStepSize;
			uiCreateCollapsingHeaderSubWidget(&CollapsingBlendParamsWidgets, "Clip Weight [Jog]", &sliderFloat, WIDGET_TYPE_SLIDER_FLOAT);
			...
			sliderFloat.mMax = fValMax;
			sliderFloat.mStep = sliderStepSize;
			uiCreateCollapsingHeaderSubWidget(&CollapsingBlendParamsWidgets, "Clip Weight [Run]", &sliderFloat, WIDGET_TYPE_SLIDER_FLOAT);
			...
			UIWidget* pPlayCheck = uiCreateCollapsingHeaderSubWidget(&CollapsingWalkClipWidgets, "Play", &checkbox, WIDGET_TYPE_CHECKBOX);
			uiSetWidgetOnEditedCallback(pPlayCheck, WalkClipPlayCallback);

			// Loop - Checkbox
			uiCreateCollapsingHeaderSubWidget(&CollapsingWalkClipWidgets, "", &separator, WIDGET_TYPE_SEPARATOR);

			checkbox.pData = &gUIData.mWalkClip.mLoop;
			UIWidget* pLoopCheck = uiCreateCollapsingHeaderSubWidget(&CollapsingWalkClipWidgets, "Loop", &checkbox, WIDGET_TYPE_CHECKBOX);
			uiSetWidgetOnEditedCallback(pLoopCheck, WalkClipLoopCallback);
			...
			sliderFloat.mMax = fValMax;
			sliderFloat.mStep = sliderStepSize;
			UIWidget* pAnimTime = uiCreateCollapsingHeaderSubWidget(&CollapsingWalkClipWidgets, "Animation Time", &sliderFloat, WIDGET_TYPE_SLIDER_FLOAT);
			uiSetWidgetOnActiveCallback(pAnimTime, WalkClipTimeChangeCallback);
			...
			// Play/Pause - Checkbox
			uiCreateCollapsingHeaderSubWidget(&CollapsingJogClipWidgets, "", &separator, WIDGET_TYPE_SEPARATOR);

			checkbox.pData = &gUIData.mJogClip.mPlay;
			uiSetWidgetOnEditedCallback(uiCreateCollapsingHeaderSubWidget(&CollapsingJogClipWidgets, "Play", &checkbox, WIDGET_TYPE_CHECKBOX), JogClipPlayCallback);

			// Loop - Checkbox
			uiCreateCollapsingHeaderSubWidget(&CollapsingJogClipWidgets, "", &separator, WIDGET_TYPE_SEPARATOR);

			checkbox.pData = &gUIData.mJogClip.mLoop;
			uiSetWidgetOnEditedCallback(uiCreateCollapsingHeaderSubWidget(&CollapsingJogClipWidgets, "Loop", &checkbox, WIDGET_TYPE_CHECKBOX), JogClipLoopCallback);
			...
			sliderFloat.mMax = fValMax;
			sliderFloat.mStep = sliderStepSize;
			uiSetWidgetOnActiveCallback(uiCreateCollapsingHeaderSubWidget(&CollapsingJogClipWidgets, "Animation Time", &sliderFloat, WIDGET_TYPE_SLIDER_FLOAT), JogClipTimeChangeCallback);
			...
			sliderFloat.mMax = fValMax;
			sliderFloat.mStep = sliderStepSize;
			uiCreateCollapsingHeaderSubWidget(&CollapsingJogClipWidgets, "Playback Speed", &sliderFloat, WIDGET_TYPE_SLIDER_FLOAT);
			...
			// Play/Pause - Checkbox
			uiCreateCollapsingHeaderSubWidget(&CollapsingRunClipWidgets, "", &separator, WIDGET_TYPE_SEPARATOR);

			checkbox.pData = &gUIData.mRunClip.mPlay;
			uiSetWidgetOnEditedCallback(uiCreateCollapsingHeaderSubWidget(&CollapsingRunClipWidgets, "Play", &checkbox, WIDGET_TYPE_CHECKBOX), RunClipPlayCallback);

			// Loop - Checkbox
			uiCreateCollapsingHeaderSubWidget(&CollapsingRunClipWidgets, "", &separator, WIDGET_TYPE_SEPARATOR);

			checkbox.pData = &gUIData.mRunClip.mLoop;
			uiSetWidgetOnEditedCallback(uiCreateCollapsingHeaderSubWidget(&CollapsingRunClipWidgets, "Loop", &checkbox, WIDGET_TYPE_CHECKBOX), RunClipLoopCallback);
			...
			sliderFloat.mMax = fValMax;
			sliderFloat.mStep = sliderStepSize;
			uiSetWidgetOnActiveCallback(uiCreateCollapsingHeaderSubWidget(&CollapsingRunClipWidgets, "Animation Time", &sliderFloat, WIDGET_TYPE_SLIDER_FLOAT), RunClipTimeChangeCallback);
			...
			sliderFloat.mMax = fValMax;
			sliderFloat.mStep = sliderStepSize;
			uiCreateCollapsingHeaderSubWidget(&CollapsingRunClipWidgets, "Playback Speed", &sliderFloat, WIDGET_TYPE_SLIDER_FLOAT);
			...
			luaRegisterWidget(uiCreateComponentWidget(pStandaloneControlsGUIWindow, "Jog Clip", &CollapsingJogClipWidgets, WIDGET_TYPE_COLLAPSING_HEADER));
			luaRegisterWidget(uiCreateComponentWidget(pStandaloneControlsGUIWindow, "Run Clip", &CollapsingRunClipWidgets, WIDGET_TYPE_COLLAPSING_HEADER));
	...
	void Draw()
	{
		...
		*(UniformBlockPlane*)planeViewProjCbv.pMappedData = gUniformDataPlane;
		...
		cmdDrawGpuProfile(cmd, float2(8.f, txtSize.y * 2.f + 100.0f), gGpuProfileToken, &gFrameTimeDraw);

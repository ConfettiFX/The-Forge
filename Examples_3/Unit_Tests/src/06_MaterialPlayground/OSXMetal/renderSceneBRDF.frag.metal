...
fragment float4 stageMain(VSOutput In [[stage_in]],
                            ...
                            texture2d<float, access::sample> metallicMap [[texture(5)]],
                            texture2d<float, access::sample> roughnessMap [[texture(6)]],
                            texture2d<float, access::sample> aoMap [[texture(7)]],
                            ...
                            sampler defaultSampler [[sampler(1)]])
{
    ...
    float3 specularColor = specularMap.sample(envSampler, R,  level(_roughness * 4)).rgb;

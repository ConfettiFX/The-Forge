...
#	endif
		...
		addInputAction(&actionDesc);
		actionDesc = {DefaultInputActions::UI_MOUSE_SCROLL_UP, [](InputActionContext* ctx)
		{
			if (!uiIsFocused())
		...
		addInputAction(&actionDesc);
		actionDesc = {DefaultInputActions::UI_MOUSE_SCROLL_DOWN, [](InputActionContext* ctx)
		{
			if (!uiIsFocused())
				gGamePlugin.mAppData->cameraZoom = ctx->mFloat;
			return true;
		...
		addInputAction(&actionDesc);
		actionDesc = {DefaultInputActions::ROTATE_CAMERA, [](InputActionContext* ctx)
		{

...
*/
    BEGIN_SRT_SET(PerFrame)
        DECL_CBUFFER(PerFrame, CBUFFER(VBConstantBufferData), gVBConstantBuffer)
        ...
        DECL_CBUFFER(PerFrame, CBUFFER(ParticleConstantBufferData), gParticleConstantBuffer)
        ...
        DECL_TEXTURE(PerFrame, TexCubeArray(float), gDepthCube)

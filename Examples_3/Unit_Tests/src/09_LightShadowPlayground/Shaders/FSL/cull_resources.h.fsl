...
RES(RWBuffer(UncompactedDrawArguments), uncompactedDrawArgsRW[NUM_CULLING_VIEWPORTS],         UPDATE_FREQ_PER_FRAME, u3, binding = 10);
RES(RWBuffer(atomic_uint),              indirectDrawArgsBufferAlpha[NUM_CULLING_VIEWPORTS],   UPDATE_FREQ_PER_FRAME, u5, binding = 8);
RES(RWBuffer(atomic_uint),              indirectDrawArgsBufferNoAlpha[NUM_CULLING_VIEWPORTS], UPDATE_FREQ_PER_FRAME, u7, binding = 9);
RES(RWByteBuffer,                       filteredIndicesBuffer[NUM_CULLING_VIEWPORTS],         UPDATE_FREQ_PER_FRAME, u1, binding = 11);
RES(Buffer(UncompactedDrawArguments),   uncompactedDrawArgs[NUM_CULLING_VIEWPORTS],           UPDATE_FREQ_PER_FRAME, t0,  binding = 0);

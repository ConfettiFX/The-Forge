...
StructuredBuffer<uint> filteredIndexBuffer: register(t20, UPDATE_FREQ_PER_FRAME);
StructuredBuffer<uint> indirectMaterialBuffer: register(t21, UPDATE_FREQ_PER_FRAME);

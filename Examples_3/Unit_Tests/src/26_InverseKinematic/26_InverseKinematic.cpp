...
const char* pszBases[FSR_Count] = {
	"../../../src/26_InverseKinematic/",            // FSR_BinShaders
	"../../../src/26_InverseKinematic/",            // FSR_SrcShaders
	"../../../UnitTestResources/",          // FSR_Textures
	"../../../UnitTestResources/",          // FSR_Meshes
	"../../../UnitTestResources/",          // FSR_Builtin_Fonts
	"../../../src/26_InverseKinematic/",            // FSR_GpuConfig
...
class AimIK: public IApp
{
	...
	void Draw()
	{
		...
		BufferUpdateDesc targetViewProjCbv = { pTargetUniformBuffer[gFrameIndex], &gUniformDataTarget };
		updateResource(&targetViewProjCbv);
		...
		cmdBindVertexBuffer(cmd, 1, &pJointVertexBuffer, NULL);
	...
	const char* GetName() { return "26_InverseKinematic"; }

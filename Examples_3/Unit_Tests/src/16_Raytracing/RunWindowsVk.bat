...
set OUTPATH=WindowsVKBenchmarks
...
start /d "../../PC Visual Studio 2017/x64/Release/16_Raytracing" 16_Raytracing.exe -f -b 512 -o "../../../../src/16_Raytracing/%OUTPATH%/" -api "VULKAN"
...
StructuredBuffer<UncompactedDrawArguments> uncompactedDrawArgs[NUM_CULLING_VIEWPORTS];
StructuredBuffer<uint> materialProps;

RWStructuredBuffer<uint> indirectMaterialBuffer;

...
BEGIN_SRT(TriangleFilteringCompSrtData)
#include "persistent_set.h"
#include "perframe_set.h"
BEGIN_SRT_SET(PerBatch)
	DECL_CBUFFER(PerBatch, CBUFFER(TriangleFilteringBatchData), gTriangleFilteringBatchData)
	DECL_CBUFFER(PerBatch, CBUFFER(RenderTargetInfo), gRenderTargetInfo)

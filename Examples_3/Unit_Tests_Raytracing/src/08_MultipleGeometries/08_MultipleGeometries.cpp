...
public:
	bool Init()
	{
		...
		pGuiWindow->AddProperty(UIProperty("Light Direction X", mLightDirection.x, -2.0f, 2.0f, 0.001f));
		pGuiWindow->AddProperty(UIProperty("Light Direction Y", mLightDirection.y, -2.0f, 2.0f, 0.001f));
		pGuiWindow->AddProperty(UIProperty("Light Direction Z", mLightDirection.z, -2.0f, 2.0f, 0.001f));
		/************************************************************************/
		/************************************************************************/
		return true;
	}

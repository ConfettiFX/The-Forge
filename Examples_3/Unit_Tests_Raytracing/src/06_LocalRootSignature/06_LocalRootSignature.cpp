...
public:
	bool Init()
	{
		...
		DescriptorData hitData = {};
		hitData.pName = "gHitColorRootConstant";
		hitData.pRootConstant = &hitColor;
		...
		RaytracingShaderTableRecordDesc hitRecord = { "hitGroup", pRootSignatureHit, &hitData, 1 };

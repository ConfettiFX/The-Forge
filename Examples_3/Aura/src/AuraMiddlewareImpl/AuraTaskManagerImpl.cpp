...
class TaskManagerImpl: public ITaskManager
{
	...
	bool createTaskSet(
		uint32_t group, ITASKSETFUNC pFunc, void* pArg, uint32_t uTaskCount, ITASKSETHANDLE* pDepends, uint32_t nDepends,
...
bool TaskManagerImpl::createTaskSet(
	uint32_t group, ITASKSETFUNC pFunc, void* pArg, uint32_t uTaskCount, ITASKSETHANDLE* pDepends, uint32_t nDepends, const char* setName,
	ITASKSETHANDLE* pOutHandle)
{
#ifdef ENABLE_CPU_PROPAGATION

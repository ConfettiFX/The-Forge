...
static KeyMappingDescription gXboxMappings[] = {
	// IMGUI mappings
	{ IMGUI_NAVINPUT_ACTIVATE, INPUT_X_AXIS, GainputDeviceType::GAINPUT_GAMEPAD, DEFINE_DEVICE_ACTION(gainput::PadButtonA, ACTION_TRIGGERED), 1.0f },
	{ IMGUI_NAVINPUT_CANCEL, INPUT_X_AXIS, GainputDeviceType::GAINPUT_GAMEPAD, DEFINE_DEVICE_ACTION(gainput::PadButtonB, ACTION_TRIGGERED), 1.0f },
	...
	{ IMGUI_NAVINPUT_DPADUP, INPUT_X_AXIS, GainputDeviceType::GAINPUT_GAMEPAD, DEFINE_DEVICE_ACTION(gainput::PadButtonUp, ACTION_TRIGGERED), 1.0f },
	{ IMGUI_NAVINPUT_DPADDOWN, INPUT_X_AXIS, GainputDeviceType::GAINPUT_GAMEPAD, DEFINE_DEVICE_ACTION(gainput::PadButtonDown, ACTION_TRIGGERED), 1.0f },
	{ IMGUI_NAVINPUT_DPADLEFT, INPUT_X_AXIS, GainputDeviceType::GAINPUT_GAMEPAD, DEFINE_DEVICE_ACTION(gainput::PadButtonLeft, ACTION_TRIGGERED), 1.0f },
	{ IMGUI_NAVINPUT_DPADRIGHT, INPUT_X_AXIS, GainputDeviceType::GAINPUT_GAMEPAD, DEFINE_DEVICE_ACTION(gainput::PadButtonRight, ACTION_TRIGGERED), 1.0f },
	{ IMGUI_NAVINPUT_FOCUSNEXT, INPUT_X_AXIS, GainputDeviceType::GAINPUT_GAMEPAD, DEFINE_DEVICE_ACTION(gainput::PadButtonL1, ACTION_TRIGGERED), 1.0f },
	{ IMGUI_NAVINPUT_FOCUSPREV, INPUT_X_AXIS, GainputDeviceType::GAINPUT_GAMEPAD, DEFINE_DEVICE_ACTION(gainput::PadButtonR1, ACTION_TRIGGERED), 1.0f },
	{ IMGUI_NAVINPUT_TWEAKFAST, INPUT_X_AXIS, GainputDeviceType::GAINPUT_GAMEPAD, DEFINE_DEVICE_ACTION(gainput::PadButtonL1, ACTION_TRIGGERED), 1.0f },
	{ IMGUI_NAVINPUT_TWEAKSLOW, INPUT_X_AXIS, GainputDeviceType::GAINPUT_GAMEPAD, DEFINE_DEVICE_ACTION(gainput::PadButtonR1, ACTION_TRIGGERED), 1.0f },

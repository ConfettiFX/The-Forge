...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Querying Window Status (Focused/Hovered etc.)"))
    {
        ...
        if (embed_all_inside_a_child_window)
            ImGui::BeginChild("outer_child", ImVec2(0.f, ImGui::GetFontSize() * 20.0f), ImGuiChildFlags_Border);
...
static void ShowDemoWindowLayout()
{
    ...
    if (ImGui::TreeNode("Child windows"))
    {
        ...
        // Child 1: no border, enable horizontal scrollbar
        {
            ...
            ImGui::BeginChild("ChildL", ImVec2(ImGui::GetContentRegionAvail().x * 0.5f, 260.f), ImGuiChildFlags_None, window_flags);
            for (int i = 0; i < 100; i++)
    ...
    if (ImGui::TreeNode("Scrolling"))
    {
        ...
        for (int i = 0; i < 5; i++)
        {
            ...
            bool child_is_visible = ImGui::BeginChild(child_id, ImVec2(-100.f, child_height), ImGuiChildFlags_Border, child_flags);
            if (scroll_to_off)
        ...
        ImVec2 scrolling_child_size = ImVec2(0.f, ImGui::GetFrameHeightWithSpacing() * 7 + 30);
            ...
            // Without clipper
            {
...
#endif
                {
                    ...
                    else if (contents_type == CT_Selectable || contents_type == CT_SelectableSpanRow)
                    {
                        ...
                        if (ImGui::Selectable(label, item_is_selected, selectable_flags, ImVec2(0.f, row_min_height)))
                        {
                            if (ImGui::GetIO().KeyCtrl)
                            {
                                if (item_is_selected)
...
static void ShowDemoWindowColumns()
{
    ...
    if (ImGui::TreeNode("Horizontal Scrolling"))
    {
        ...
        ImVec2 child_size = ImVec2(0.f, ImGui::GetFontSize() * 20.0f);
...
void ImGui::ShowAboutWindow(bool* p_open)
{
    ...
    if (show_config_info)
    {
        ...
        ImVec2 child_size = ImVec2(0.f, ImGui::GetTextLineHeightWithSpacing() * 18);
...
struct ExampleAppConsole
{
    ...
    void    Draw(const char* title, bool* p_open)
    {
        ...
        if (ImGui::BeginChild("ScrollingRegion", ImVec2(0.f, -footer_height_to_reserve), ImGuiChildFlags_None, ImGuiWindowFlags_HorizontalScrollbar))
        {
...
static void ShowExampleAppLayout(bool* p_open)
{
    ...
    if (ImGui::Begin("Example: Simple layout", p_open, ImGuiWindowFlags_MenuBar))
    {
        ...
        {
            ImGui::BeginGroup();
            ImGui::BeginChild("item view", ImVec2(0.f, -ImGui::GetFrameHeightWithSpacing())); // Leave room for 1 line below us
...
static void ShowExampleAppConstrainedResize(bool* p_open)
{
    ...
    if (type == 4) ImGui::SetNextWindowSizeConstraints(ImVec2(400, -1),  ImVec2(500.f, -1.f));      // Width Between and 400 and 500
    if (type == 5) ImGui::SetNextWindowSizeConstraints(ImVec2(-1, 500),  ImVec2(-1.f, FLT_MAX));    // Height at least 400

...
namespace ShaderTranslator
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class GLSLCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("e140750d-f52f-4fdd-b633-baebfe14563c");
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GLSLCommand"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        /// <param name="commandService">Command service to add command to, not null.</param>
        private GLSLCommand(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        /// </summary>
        public static GLSLCommand Instance
        {
            get;
            private set;
        }
        ...
        {
            // Verify the current thread is the UI thread - the call to AddCommand in GLSLCommand's constructor requires
            // the UI thread.
            ThreadHelper.ThrowIfNotOnUIThread();

            OleMenuCommandService commandService = await package.GetServiceAsync((typeof(IMenuCommandService))) as OleMenuCommandService;
            Instance = new GLSLCommand(package, commandService);
        }
        ...
        private async void MenuItemCallback(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < processArray.Count; ++i)
            {
                ...
                if (processArray[i].process.ExitCode != 0)
                {
                    ...
                    startInfo.Arguments = String.Format("-{0} -glsl {1} main {2}", processArray[i].language, processArray[i].fileName, processArray[i].outputName);

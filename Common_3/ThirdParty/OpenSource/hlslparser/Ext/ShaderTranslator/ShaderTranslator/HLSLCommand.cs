...
namespace ShaderTranslator
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class HLSLCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("cf13c587-06dd-4f4c-9fd0-2d28db2a6965");
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HLSLCommand"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        /// <param name="commandService">Command service to add command to, not null.</param>
        private HLSLCommand(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        /// </summary>
        public static HLSLCommand Instance
        {
            get;
            private set;
        }
        ...
        {
            // Verify the current thread is the UI thread - the call to AddCommand in HLSLCommand's constructor requires
            // the UI thread.
            ThreadHelper.ThrowIfNotOnUIThread();

            OleMenuCommandService commandService = await package.GetServiceAsync((typeof(IMenuCommandService))) as OleMenuCommandService;

            Instance = new HLSLCommand(package, commandService);
        ...
        private async void MenuItemCallback(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < processArray.Count; ++i)
            {
                ...
                if (processArray[i].process.ExitCode != 0)
                {
                    ...
                    startInfo.Arguments = String.Format("-{0} -hlsl {1} main {2}", processArray[i].language, processArray[i].fileName, processArray[i].outputName);

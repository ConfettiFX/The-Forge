...
inline void TinyImageFormat_ToGL_FORMAT(TinyImageFormat fmt, uint32_t *glformat, uint32_t* gltype, uint32_t* glinternalformat, uint32_t* typesize) {
	...
	case TinyImageFormat_ASTC_12x12_SRGB: FTC(SRGB_ALPHA, SRGB8_ALPHA8_ASTC_12x12)
		...
		// Depth
	case TinyImageFormat_D32_SFLOAT: FT(SRGB_ALPHA, FLOAT, DEPTH_COMPONENT32F, 4)
	case TinyImageFormat_D16_UNORM: FT(RG, UNSIGNED_SHORT, DEPTH_COMPONENT16, 2)
	case TinyImageFormat_S8_UINT: FT(RED_INTEGER, UNSIGNED_BYTE, STENCIL_INDEX8, 1)

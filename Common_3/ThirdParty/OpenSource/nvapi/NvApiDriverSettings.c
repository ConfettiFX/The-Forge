...
EValues_PS_FRAMERATE_LIMITER g_valuesPS_FRAMERATE_LIMITER[PS_FRAMERATE_LIMITER_NUM_VALUES] = 
{
    ...
    PS_FRAMERATE_LIMITER_LOW_LATENCY_LOG,
...
EValues_PS_FRAMERATE_MONITOR_CTRL g_valuesPS_FRAMERATE_MONITOR_CTRL[PS_FRAMERATE_MONITOR_CTRL_NUM_VALUES] = 
{
    ...
    PS_FRAMERATE_MONITOR_CTRL_LOW_LATENCY_LOG,
    ...
    PS_FRAMERATE_MONITOR_CTRL_FRL_OFFSET_MASK,
    PS_FRAMERATE_MONITOR_CTRL_FRL_OFFSET_SHIFT,
    ...
    PS_FRAMERATE_MONITOR_CTRL_OPTIMAL_SETTING_V2,
    PS_FRAMERATE_MONITOR_CTRL_VSYNC_OPTIMAL_SETTING,
    PS_FRAMERATE_MONITOR_CTRL_VSYNC_OPTIMAL_SETTING_V2,
};
...
SettingDWORDNameString mapSettingDWORD[TOTAL_DWORD_SETTING_NUM] = 
{
    ...
    {PS_FRAMERATE_LIMITER_ID,              PS_FRAMERATE_LIMITER_STRING,              21, (NvU32 *)g_valuesPS_FRAMERATE_LIMITER,    PS_FRAMERATE_LIMITER_DISABLED},
    {PS_FRAMERATE_LIMITER_2_CONTROL_ID,    PS_FRAMERATE_LIMITER_2_CONTROL_STRING,     9, (NvU32 *)g_valuesPS_FRAMERATE_LIMITER_2_CONTROL, 0x00000000},
    ...
    {PS_FRAMERATE_MONITOR_CTRL_ID,         PS_FRAMERATE_MONITOR_CTRL_STRING,         19, (NvU32 *)g_valuesPS_FRAMERATE_MONITOR_CTRL, PS_FRAMERATE_MONITOR_CTRL_DISABLED},
    ...
    {SHIM_RENDERING_OPTIONS_ID,            SHIM_RENDERING_OPTIONS_STRING,            27, (NvU32 *)g_valuesSHIM_RENDERING_OPTIONS,  0x00000000},

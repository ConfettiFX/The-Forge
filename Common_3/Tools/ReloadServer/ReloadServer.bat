...
set cwd=%cd%
IF "%cwd:~-9%" == "The-Forge" (
    Data\Tools\python-3.6.0-embed-amd64\python.exe Common_3\Tools\ReloadServer\ReloadServer.py %*
) ELSE (
    if "%cwd:~-12%" == "ReloadServer" (
        ..\..\..\Data\Tools\python-3.6.0-embed-amd64\python.exe ReloadServer.py %*
    ) ELSE (

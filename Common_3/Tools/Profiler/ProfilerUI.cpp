...
PROFILE_DEFINE(g_ProfileDetailed, "Profile", "Detailed View", 0x8888000);
PROFILE_DEFINE(g_ProfileDrawGraph, "Profile", "Draw Graph", 0xff44ee00);
PROFILE_DEFINE(g_ProfileDrawBarView, "Profile", "DrawBarView", 0x00dd77);
PROFILE_DEFINE(g_ProfileDraw, "Profile", "Draw", 0x737373);
...
void ProfileDrawDetailedView(uint32_t nWidth, uint32_t nHeight, bool bDrawBars)
{
	...
	PROFILE_SCOPE(g_ProfileDetailed);
...
bool ProfileDrawGraph(uint32_t nScreenWidth, uint32_t nScreenHeight)
{
	...
	PROFILE_SCOPE(g_ProfileDrawGraph);
	bool bEnabled = false;
...
void ProfileDrawCounterView(uint32_t nScreenWidth, uint32_t nScreenHeight)
{
    ...
    ProfileUI & UI = g_ProfileUI;
	Profile& S = *ProfileGet();
	PROFILE_SCOPE(g_ProfileDrawBarView);
...
#define PROFILE_MENU_MAX 16
...

	{
		...
		ProfileDrawText(nWidth - 205, 0, -1, FrameTimeMessage, nLen);
	}
}

...
#define MZ_STREAM_PROP_COMPRESS_WINDOW (11)
	...
	//bool mz_stream_raw_is_open(FileStream *stream);
	...
	ssize_t mz_stream_raw_tell(const FileStream* stream);
	...
	bool    mz_stream_raw_flush(FileStream* stream);
	//bool mz_stream_raw_error(FileStream *stream);

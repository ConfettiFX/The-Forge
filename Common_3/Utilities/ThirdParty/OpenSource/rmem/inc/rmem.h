 ...
 *------------------------------------------------------------------------*/
#if (                                                                                                                              \
	defined(__x86_64__) || defined(__x86_64) || defined(__amd64__) || defined(__amd64) || defined(__ppc64__) || defined(_WIN64) || \
...
#define RMEM_MARKER(_name, _color)                                                \
	static RMemMarker CONCAT(Marker, __LINE__) = rmemCreateMarker(_name, _color); \
	rmemSetMarker(&CONCAT(Marker, __LINE__));

#define RMEM_MARKER_RGB(_name, _r, _g, _b)                                               \
	static RMemMarker CONCAT(Marker, __LINE__) = rmemCreateMarkerRGB(_name, _r, _g, _b); \
	rmemSetMarker(&CONCAT(Marker, __LINE__));
 ...
 *------------------------------------------------------------------------*/
#define RMEM_REGISTER_TAG(_name) RMemTagRegistration CONCAT(tag, __LINE__)(_name);

#define RMEM_REGISTER_TAG_CHILD(_name, _parentName) RMemTagRegistration CONCAT(tag, __LINE__)(_name, _parentName);

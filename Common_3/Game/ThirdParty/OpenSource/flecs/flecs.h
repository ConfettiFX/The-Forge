...
#define ECS_COMPONENT_DEFINE(world, id) \
    {\
        ecs_assert(ecs_lookup_fullpath(world, #id) == 0, ECS_ID_IN_USE, "component with this name already exists"); \
...
#define ECS_TRIGGER_DEFINE(world, id, kind, component) \
    {\
        ecs_assert(ecs_lookup_fullpath(world, #id) == 0, ECS_ID_IN_USE, "trigger with this name already exists"); \
...
#define ECS_OBSERVER_DEFINE(world, id, kind, ...)\
    {\
        ecs_assert(ecs_lookup_fullpath(world, #id) == 0, ECS_ID_IN_USE, "observer with this name already exists"); \
...
#define ECS_SYSTEM_DEFINE(world, id, kind, ...) \
    { \
        ecs_assert(ecs_lookup_fullpath(world, #id) == 0, ECS_ID_IN_USE, "system with this name already exists"); \

...
void registerSliderFloatWidgetLua(const UIWidget* pWidget)
{
	...
	pLuaManager->SetFunction((const char*)functionName.data, [data](ILuaStateWrap* state) -> int {
...
void registerTextboxWidgetLua(const UIWidget* pWidget)
{
	...
	pLuaManager->SetFunction((const char*)functionName.data, [pText](ILuaStateWrap* state) -> int {
		const char* str;
...
void registerDynamicTextWidgetLua(const UIWidget* pWidget)
{
	...
	pLuaManager->SetFunction((const char*)functionName.data, [pText, pColor](ILuaStateWrap* state) -> int {
		const char* str;
		state->GetStringArg(1, &str);
		if (!str)
			str = "";
...
void luaRegisterWidget(const void* pWidgetHandle)
{
	...
	if (pWidget->pOnHover)
	{
		...
		pLuaManager->SetFunction((const char*)functionName.data, [fn = pWidget->pOnHover, data = pWidget->pOnHoverUserData](ILuaStateWrap* state) -> int {
			fn(data);
			return 0;
		});
	}
	if (pWidget->pOnActive)
	{
		...
		pLuaManager->SetFunction((const char*)functionName.data, [fn = pWidget->pOnActive, data = pWidget->pOnActiveUserData](ILuaStateWrap* state) -> int {
			fn(data);
			return 0;
		});
	}
	if (pWidget->pOnFocus)
	{
		...
		pLuaManager->SetFunction((const char*)functionName.data, [fn = pWidget->pOnFocus, data = pWidget->pOnFocusUserData](ILuaStateWrap* state) -> int {
			fn(data);
			return 0;
		});
	}
	if (pWidget->pOnEdited)
	{
		...
		pLuaManager->SetFunction((const char*)functionName.data, [fn = pWidget->pOnEdited, data = pWidget->pOnEditedUserData](ILuaStateWrap* state) -> int {
			fn(data);
			return 0;
		});
	}
	if (pWidget->pOnDeactivated)
	{
		...
		pLuaManager->SetFunction((const char*)functionName.data, [fn = pWidget->pOnDeactivated, data = pWidget->pOnDeactivatedUserData](ILuaStateWrap* state) -> int {
			fn(data);
			return 0;
		});
	}
	if (pWidget->pOnDeactivatedAfterEdit)
	{
		...
		pLuaManager->SetFunction((const char*)functionName.data, [fn = pWidget->pOnDeactivatedAfterEdit, data = pWidget->pOnDeactivatedAfterEditUserData](ILuaStateWrap* state) -> int {
			fn(data);
			return 0;
		});
	}

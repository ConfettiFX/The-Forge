...
public:
	...
	WidgetCallback pOnDeactivatedAfterEdit;	 // Widget was just made inactive from an active state and changed its underlying value.  This is useful for undo/redo patterns.
...
{
public:
	LabelWidget(const tinystl::string& _label) :
		IWidget(_label) {}
...
{
public:
	ButtonWidget(const tinystl::string& _label) :
		IWidget(_label) {}
...
{
public:
	SliderFloatWidget(const tinystl::string& _label, float* _data, float _min, float _max, float _step = 0.01f, const tinystl::string& _format = "%.3f") :
		IWidget(_label),
		mFormat(_format),
		pData(_data),
		mMin(_min),
...
{
public:
	SliderFloat2Widget(const tinystl::string& _label, float2* _data, const float2& _min, const float2& _max, const float2& _step = float2(0.01f, 0.01f), const tinystl::string& _format = "%.3f") :
		IWidget(_label),
		mFormat(_format),
		pData(_data),
		mMin(_min),
...
{
public:
	SliderFloat3Widget(const tinystl::string& _label, float3* _data, const float3& _min, const float3& _max, const float3& _step = float3(0.01f, 0.01f, 0.01f), const tinystl::string& _format = "%.3f") :
		IWidget(_label),
		mFormat(_format),
		pData(_data),
		mMin(_min),
...
{
public:
	SliderFloat4Widget(const tinystl::string& _label, float4* _data, const float4& _min, const float4& _max, const float4& _step = float4(0.01f, 0.01f, 0.01f, 0.01f), const tinystl::string& _format = "%.3f") :
		IWidget(_label),
		mFormat(_format),
		pData(_data),
		mMin(_min),
...
{
public:
	SliderIntWidget(const tinystl::string& _label, int32_t* _data, int32_t _min, int32_t _max, int32_t _step = 1, const tinystl::string& _format = "%d") :
		IWidget(_label),
		mFormat(_format),
		pData(_data),
		mMin(_min),
...
{
public:
	SliderUintWidget(const tinystl::string& _label, uint32_t* _data, uint32_t _min, uint32_t _max, uint32_t _step = 1, const tinystl::string& _format = "%d") :
		IWidget(_label),
		mFormat(_format),
		pData(_data),
		mMin(_min),
...
{
public:
	CheckboxWidget(const tinystl::string& _label, bool* _data) :
		IWidget(_label),
		pData(_data)
	{}
	IWidget* Clone() const;
...
{
public:
	ColorSliderWidget(const tinystl::string& _label, uint32_t* _data) :
		IWidget(_label),
		pData(_data) {}
...
{
public:
	ColorPickerWidget(const tinystl::string& _label, uint32_t* _data) :
		IWidget(_label),
		pData(_data) {}
